...
write(as.numeric(bioutput$converged), file = '../output/conv.pen.txt', append=TRUE)
write(LLRT, file = '../output/LLRT.pen.txt', append = TRUE)
write(w, file = '../output/log.pen.txt', append = TRUE)
write(as.vector(t)[3], file = '../output/itertime.pen.txt', append = TRUE)
}
