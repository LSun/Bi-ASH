...
bioutput=bimixEM(array_lik,prior,control = list(maxiter = 50000))
...
system("mkdir ../output/biASHSimMoreIter")
save(converged,LLRTres,iter_time,file="../output/biASHSimMoreIter/res.RData")